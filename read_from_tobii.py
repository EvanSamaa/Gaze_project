...
if __name__ == "__main__":
    ...
    # ========================================
    # vicon
    input_path = "F:/MASC/JALI_gaze/Tobii_Vicon_recording/Integration_test/vicon2.csv"
    # tobii
    input_tobii = "F:/MASC/JALI_gaze/Tobii_Vicon_recording/Integration_test/tobii2/segments/1/livedata.json.gz"
    # output_path
