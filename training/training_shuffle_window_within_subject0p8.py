...
def train_model_with_vel(model, config, dataset_location, training_set, testing_set, wandb, model_name, start = 1):
    ...
    training_dataset = Runtime_parsing_Aversion_SelfTape111_within_subject(dataset_location, training_set)
    validation_dataset = Runtime_parsing_Aversion_SelfTape111_within_subject(dataset_location, testing_set)
...
train_model_with_vel(model, config, dataset_location, training_set, testing_set, run_obj, "reparse_dataset_explicit_first_frame_with_pos_all_aversion_0p8", start=1)
run_obj.finish()
