...
def train_model_with_vel(model, config, dataset_location, training_set, testing_set, wandb, model_name, start = 1):
    training_dataset = Runtime_parsing_Aversion_SelfTape111_validation_leak(dataset_location, training_set, normalize_MFCC=True, apply_frequency_mask=True, percent_leaked=0.50)
...
train_model_with_vel(model, config, dataset_location, training_set, testing_set, run_obj, "reparse_dataset_explicit_first_frame_with_freq_mask_50percent_leak_lr0p001", start=1)
run_obj.finish()
