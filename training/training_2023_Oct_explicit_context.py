...
if __name__ == "__main__":
    ...
    if gpu == 1:
        ...
        config = json.load(open("/scratch/ondemand27/evanpan/Gaze_project/training/explicit_prior_frame_configL.json", "r"))
        ...
        train_model_with_vel(model, config, train_dataloader, valid_dataloader, run_obj, "sentence_and_words_with_vel_2023_Oct_explicit_prior_frame_L")
        run_obj.finish()
    else:
        pass