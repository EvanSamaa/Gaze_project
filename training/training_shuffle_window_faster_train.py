...
def get_velocity(out):
    ...
    return vel
def train_model_with_vel(device, model, config, dataset_location, training_set, testing_set, wandb, model_name, start = 1):

    training_dataset = Runtime_parsing_Aversion_SelfTape111(dataset_location, training_set)
...
train_model_with_vel(device, model, config, dataset_location, training_set, testing_set, run_obj, "reparse_dataset_explicit_first_frame_with_pos_larger_model", start=1)
run_obj.finish()
