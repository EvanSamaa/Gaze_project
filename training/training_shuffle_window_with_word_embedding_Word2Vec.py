...
train_model_with_vel(model, config, dataset_location, training_set, testing_set, run_obj, "reparse_dataset_explicit_first_frame_with_pos_long_aversion_only_word_embedding_Word2Vec", device_string=device_string)
run_obj.finish()
