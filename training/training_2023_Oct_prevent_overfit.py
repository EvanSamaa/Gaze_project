...
class Audio_only_GazePredictionModel(nn.Module):
    def __init__(self, config):
        ...
        # change the lstm to bidirectional
...
if __name__ == "__main__":
    ...
    train_model_with_vel(model, config, train_dataloader, valid_dataloader, run_obj, "sentence_and_words_with_vel_2023_Oct_prevent_overfitting_fixed_input_layers")
    run_obj.finish()
